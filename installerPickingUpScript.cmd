...
rem sign ifind.exe
"C:\Program Files (x86)\Windows Kits\8.1\bin\x64\signtool.exe" sign /t http://timestamp.verisign.com/scripts/timstamp.dll /f "anna_dev_cert.p12" /p o{P87=bD14Unj /d "ifind.exe" "Installer\ifind.exe"
"C:\Program Files (x86)\Windows Kits\8.1\bin\x64\signtool.exe" verify /pa "Installer\ifind.exe"
